package com.krishna.retrofit.eversaleskotlinnewversion
/**
...
object Keys {
    ...
    const val testURL = "http://test.evergreenpublications.in/"
    ...
    const val URL_SchoolListWithName: String = "http://test.evergreenpublications.in/ESale/SIN/sN/SchoolListWithName"
    ...
    const val URL_TodayProductBillByLocation: String = "http://test.evergreenpublications.in/ESale/SOR/SNV/TodayProductBillByLocation"
    const val URL_TotalProductBillByLocation: String = "http://test.evergreenpublications.in/ESale/SOR/SNV/TotalProductBillByLocation"
    const val URL_TotalProductBillByLocationDate: String = "http://test.evergreenpublications.in/ESale/SOR/SNV/TotalProductBillByLocationDate"
    const val URL_BillListByLocation: String = "http://test.evergreenpublications.in/ESale/SOR/SNV/BillListByLocation"
    ...
    const val URL_CheckAreaCode: String = "http://test.evergreenpublications.in/ESale/SIn/SN/CheckAreaCode"
    ...
    const val URL_AvailableStock: String = "http://test.evergreenpublications.in/ESale/SIN/SN/AvailableStock"
    ...
    const val URL_ProductListById1: String = "http://test.evergreenpublications.in/ESale/SIN/SN/ProductListById1"
    ...
    const val URL_BindProductType: String = "http://test.evergreenpublications.in/ESale/SIn/SN/BindProductType"
    const val URL_ClassByProductType: String = "http://test.evergreenpublications.in/ESale/SIn/SN/ClassByProductType"
    const val URL_ProductListByType: String = "http://test.evergreenpublications.in/ESale/SIn/SN/ProductListByType"
    ...
    const val URL_CheckBillExist: String = "http://test.evergreenpublications.in/ESale/SO/SNV/CheckBillExist"
    ...
    const val URL_StockReturnListBySchoolClass: String = "http://test.evergreenpublications.in/ESale/SOR/SNV/StockReturnListBySchoolClass"
